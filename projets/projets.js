...
window.PROJETS = [
  /* ---- projet réel : habiter, produire, partager — Berchem-Sainte-Agathe (atelier II, LOCI UCLouvain, 2025-2026) ---- */
  {
    ...
    diapos: [
      ...
      { src: 'projets/images/tsa-model-03-entrance_1400.webp', w: 1400, h: 1867, legende: 'the model — into the yard, the entrance under the sawtooth roofs, young trees' },
      { src: 'projets/images/tsa-model-04-hall_1400.webp', w: 1400, h: 1867, legende: 'the model, inside — the long hall under the roofs, shelving on either side' },
      ...
      { src: 'projets/images/tsa-map-medallions_1400.webp', w: 1400, h: 440, legende: 'local context, four medallions at 1:15 000 — left to right: connections, zoning, building heights, figure-ground; the warehouse in red' },
