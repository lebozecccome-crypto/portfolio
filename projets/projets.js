...
window.PROJETS = [
  /* ---- projet réel : habiter, produire, partager — Berchem-Sainte-Agathe (atelier II, LOCI UCLouvain, 2025-2026) ---- */
  {
    ...
    diapos: [
      ...
      { src: 'projets/images/tsa-concept_2800.webp', w: 2800, h: 1041, echelle: 0.33, legende: 'concept — fragmenting the volume, subtracting to open the yard and the garden, then opening the façades to light and to the Hain' },
