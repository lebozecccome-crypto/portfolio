...
window.PROJETS = [
  /* ---- projet réel : habiter, produire, partager — Berchem-Sainte-Agathe (atelier II, LOCI UCLouvain, 2025-2026) ---- */
  {
    ...
    description: 'In Berchem-Sainte-Agathe, a collective housing building of six dwellings stands on a through plot at the heart of the urban block, with a food-producing garden in the depth of the plot. The project sets out a gradation from public to private — the street, the great common, the common, the small common, the bedroom — and tightens the living rooms so that people come together in the shared spaces, around food production that links the dwellings to one another and to the neighbourhood.',
    texte: [
      'Over the past seventy years, the modernization of housing has progressively led to the expansion of private space; in the past, an entire family could live within a single room. The project takes the opposite approach by reducing the space devoted strictly to the private sphere in favour of a diversity of shared spaces. This reduction is not conceived as a loss, but rather as a way of encouraging encounters between residents and shifting certain activities into communal spaces. By being less isolated within their homes, residents are more encouraged to inhabit, invest in, and appropriate these shared spaces.',
      'The project therefore creates a gradation of spaces, from the street to the most intimate areas: the street and the market extend the life of the neighbourhood, the garden and greenhouse provide shared spaces, while the building offers different opportunities for encounter and appropriation. Communal spaces are therefore not simply circulation areas between dwellings; they become genuine places of everyday life. Each threshold is conceived as an inhabited space, capable of encouraging interaction rather than simply functioning as a door separating the public from the private.',
    ],
    ...
    diapos: [
      ...
      { src: 'projets/images/tsa-model-01-overview_1400.webp', w: 1400, h: 1050, legende: 'the model — the sawtooth roofs around the central yard' },
      { src: 'projets/images/tsa-model-02-yard_1400.webp', w: 1400, h: 1050, legende: 'the model — the yard, the timber truss and the sawtooth roofs' },
      { src: 'projets/images/tsa-model-05-workshop_1400.webp', w: 1400, h: 1867, legende: 'the model, inside — a workshop room, its furniture and the glazing onto the garden' },
      { src: 'projets/images/tsa-map-situation_1400.webp', w: 1400, h: 2013, legende: 'location plan, 1:6 000 — the site outlined in red, the Hain running north–south past it, railway line 124 to the east' },
